...
public struct PongDOTSGhostSerializerCollection : IGhostSerializerCollection
{
    ...
    public int Serialize(SerializeData data)
    {
        switch (data.ghostType)
        {
            case 0:
            {
                return GhostSendSystem<PongDOTSGhostSerializerCollection>.InvokeSerialize<CubeGhostSerializer, CubeSnapshotData>(m_CubeGhostSerializer, data);
            }
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnablePongDOTSGhostSendSystemComponent : IComponentData
{}
public class PongDOTSGhostSendSystem : GhostSendSystem<PongDOTSGhostSerializerCollection>
{
    protected override void OnCreate()
    {
        base.OnCreate();
        RequireSingletonForUpdate<EnablePongDOTSGhostSendSystemComponent>();
    }
}

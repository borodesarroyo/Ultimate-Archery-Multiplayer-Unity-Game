...
public struct PongDOTSGhostDeserializerCollection : IGhostDeserializerCollection
{
        ...
        ref DataStreamReader.Context ctx, NetworkCompressionModel compressionModel)
    {
        ...
        {
            case 0:
                return GhostReceiveSystem<PongDOTSGhostDeserializerCollection>.InvokeDeserialize(m_CubeSnapshotDataFromEntity, entity, snapshot, baseline, baseline2,
        ...
        ref DataStreamReader.Context ctx, NetworkCompressionModel compressionModel)
    {
        switch (serializer)
        {
            case 0:
                ...
                m_CubeSnapshotDataNewGhosts.Add(GhostReceiveSystem<PongDOTSGhostDeserializerCollection>.InvokeSpawn<CubeSnapshotData>(snapshot, reader, ref ctx, compressionModel));
                break;
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnablePongDOTSGhostReceiveSystemComponent : IComponentData
{}
public class PongDOTSGhostReceiveSystem : GhostReceiveSystem<PongDOTSGhostDeserializerCollection>
{
    protected override void OnCreate()
    {
        base.OnCreate();
        RequireSingletonForUpdate<EnablePongDOTSGhostReceiveSystemComponent>();
    }
}
